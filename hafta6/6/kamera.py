...
alt_sınır_mavi = np.array([90, 100, 100])
üst_sınır_mavi = np.array([130, 255, 255])
...
while True:
    ...
    # Trackbar'lardan HSV değerlerini güncelle
    ...
    if büyük_sınır is not None:
        x, y, w, h = cv2.boundingRect(büyük_sınır)
        cv2.rectangle(kamera_görüntü, (x, y), (x + w, y + h), (255, 0, 0), 2)
